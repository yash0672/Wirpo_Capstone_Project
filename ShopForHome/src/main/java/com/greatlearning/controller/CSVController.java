...
import com.greatlearning.helper.ResponseMessage;
import com.greatlearning.serviceImpl.CSVService;
...
public class CSVController {
	...
	public ResponseEntity<ResponseMessage> uploadFile(@RequestParam("file") MultipartFile file){
		String message = "" ;
		if(CSVHelper.hasCSVFormat(file)==1) {
			try {
		...
		message = "Please uplaod csv file!";
